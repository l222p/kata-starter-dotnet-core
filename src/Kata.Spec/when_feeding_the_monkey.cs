...
// Given the user input is empty when calculating the sum then it should return zero.
    public class when_user_input_is_empty
    {
        ...
        It should_return_a_zero = () => { _result.Should().Be(0); };
    ...
    public class when_user_inputs_one_number
    {
    ...
    public class when_user_inputs_unknown_amount_of_numbers
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_user_inputs_multiple_numbers_with_comma_and_new_line
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_user_input_with_custom_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_inputs_one_negative_number
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };

        private Because of = () => { _result = Catch.Exception(() => _systemUnderTest.Add("2,3,-1")); };

        It should_return_throw_an_exception = () => { _result.Message.Should().Be("negatives not allowed: -1"); };
        private static Calculator _systemUnderTest;
